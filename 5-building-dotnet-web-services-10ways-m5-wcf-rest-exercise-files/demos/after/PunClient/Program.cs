...
namespace PunClient
{
    class Program
    {
        ...
        private static void EditPun(int index)
        {
            ...
            var result = _service.UpdatePun(pun);
            Console.WriteLine("Updated pun at PunID: " + result.PunID);
        }
        ...
        private static void EnterPun()
        {
            ...
            var createdPun = _service.CreatePun(pun);
            Console.WriteLine("Pun created with ID: " + createdPun.PunID);
        }
